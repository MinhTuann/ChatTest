...
public class MainActivity extends AppCompatActivity {
        ...
        getCurrentUEventLisnter = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try {
                    ...
                    uid = (String)intent.getExtras().getSerializable("GROUPCHATS");
                    loadMessagesFromFirebase(uid);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!edtMessage.getText().toString().isEmpty()) {
                    API.addMessage(currentLoggedInUser, edtMessage.getText().toString(), uid);
                    edtMessage.setText("");
                }
            }
        });
    ...
    public void loadMessagesFromFirebase(String uid) {
        API.firebaseRef.child("GROUPIDS").child(uid).child("MESSAGES").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.m_return_home:
                Intent group = new Intent(MainActivity.this, ListActivity.class);
                startActivity(group);
                break;
        }
